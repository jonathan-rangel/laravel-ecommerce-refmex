                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div id="product-1" class="single-product">
                        <a href="<?php echo e(url('/producto/'.$product->Category->name.'/'.$product->id)); ?>">
                            <div class="part-1"
                                style="background-image: url(/storage/<?php echo e($product->image_path); ?>); background-size: cover; background-position:center center">
                            </div>
                        </a>
                        <div class="part-2">
...
<!-- partial -->
<?php /**PATH C:\laragon\www\laravel-ecommerce-refmex\resources\views/layouts/popular_products.blade.php ENDPATH**/ ?>